            ...
            <div class="col-lg-12 col-md-12">
              <div class="card">
                ...
                <?php } ?>
                  ...
                  <form class="mb-5" action="<?php echo base_url('admin/landing/aksi-edit-game-news'); ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8 col-md-8">
                        ...
                        <input name="id" type="hidden" class="form-control" value="<?= $data->id_game_news ?>" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-2 col-md-2">
