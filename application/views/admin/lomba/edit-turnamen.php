              ...
              <div class="col-lg-12 col-md-12">
                <div class="card">
                  <div class="card-header card-header-danger">
                    ...
                    <p class="card-category">Berikut Form untuk mengubah Turnamen pada Inesa, Gunakanlah dengan Bijak.</p>
                  </div>
                  <div class="card-body table-responsive">
                    <form class="mb-5" action="<?php echo base_url();?>turnamen/AksiEditTurnamen/<?= $data->id_turnamen ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-8 col-md-8">
                            <input name="penyelenggara" type="text" class="form-control" value="<?= $data->penyelenggara ?>" required>
                        </div>
                        </div>
                        <div class="form-group row">
                        <div class="col-sm-2 col-md-2">
                        ...
                        <div class="col-sm-8 col-md-8">
                            <input name="slot" type="number" class="form-control" value="<?= $data->jumlah_tim ?>" required>
                        </div>
                        </div>
                        <div class="form-group row">
                        <div class="col-sm-2 col-md-2">
                        ...
                        <div class="col-sm-8 col-md-8">
                            <input name="slot_peserta" type="number" class="form-control" value="<?= $data->jumlah_anggota ?>" required>
                        </div>
                        </div>
                        <div class="form-group row">
                        <div class="col-sm-2 col-md-2">
                        ...
                        <div class="col-sm-8 col-md-8">
                            <input name="tgl_deadline" type="date" class="form-control" value="<?= $data->deadline_pendaftaran ?>" required>
                        </div>
                        </div>
                        <div class="form-group row">
                        <div class="col-sm-2 col-md-2">
                        ...
                        <div class="col-sm-8 col-md-8">
                            <input name="tgl_mulai" type="date" class="form-control" value="<?= $data->tanggal_pelaksanaan ?>" required>
                        </div>
                        </div>
                        <div class="form-group row">
                        <div class="col-sm-2 col-md-2">
                        ...
                        <div class="col-sm-8 col-md-8">
                            <input name="tgl_berakhir" type="date" class="form-control" value="<?= $data->tanggal_berakhir ?>" required>
                        </div>
                        </div>
                        <div class="form-group row">
                        <div class="col-sm-2 col-md-2">
                        ...
                        <div class="col-sm-8 col-md-8">
                            <input name="jam_mulai" type="time" class="form-control" value="<?= $data->jam_mulai ?>" required>
                        </div>
                        </div>
                        <div class="form-group row">
                        <div class="col-sm-2 col-md-2">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <textarea name="content" id="content" class="mb-5"><?= $data->deskripsi_lomba ?></textarea>
                        </div>
                        </div>
                        <div class="form-group row">
