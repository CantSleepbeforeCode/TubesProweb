<div class="jumbotron jumbotron-fluid">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            ...
            <ul class="nav nav-tabs" id="YurnamenTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="deskripsi-tab" data-toggle="tab" href="#deskripsi" role="tab" aria-controls="deskripsi" aria-selected="true">Deskripsi Lomba</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="tim-tab" data-toggle="tab" href="#tim" role="tab" aria-controls="tim" aria-selected="false">Tim</a>
                </li>
            </ul>
            <div class="tab-content" id="TurnamenTabContent">
                ...
                if($countTim == 0) { ?>
                <div class="col">
                    <p class="text-center font-weight-light">Belum ada Tim yang Terdaftar</p>
                </div>
                <?php } else { 
                    foreach($dataTim as $tim) { ?>
                        <div class="col-4 mb-3">
                            <div class="card-body text-white bg-dark rounded">
                                <h3 class="font-weight-bold"><img src="<?= base_url($tim->logo_tim);?>" class="rounded-circle border border-success mr-4" width="60" height="60"><small><?= $tim->nama_tim ?></small></h3>
                            </div>
                        </div>
                    <?php } 
                } ?>
